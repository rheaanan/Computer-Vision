...
class Gesture(object):
    ...
    def action(self, *args, **kwargs):
        ...
        if(self.name=="Horizontal Line Left to Right"):
            ...
            print('should change slide')
        if(self.name=="Diagonal Top Left to Bottom Right"):
            pyautogui.press('right')
        if(self.name=="Diagonal Bottom Left to Top Right"):
            pyautogui.press('right')
            print('should change slide')
        if(self.name=="Horizontal Line Right to Left"):
            pyautogui.press('left')
            print('should change slide')
        if(self.name=="Diagonal Bottom Right to Top Left"):
            pyautogui.press('left')
            print('should change slide')
        if(self.name=="Diagonal Top Right to Bottom Left"):
            pyautogui.press('left')
            print('should change slide')
