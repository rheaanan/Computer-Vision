...
class Gesture(object):
    ...
    def action(self, isPpt):
        #print "DEFAULT ACTION:", self.name
        if isPpt:
            if(self.name=="Horizontal Line Left to Right"):
                pyautogui.press('right')
                print('Next slide')
                
            elif(self.name=="Diagonal Top Left to Bottom Right"):
                pyautogui.press('right')
                print('Next slide')

            elif(self.name=="Diagonal Bottom Left to Top Right"):
                pyautogui.press('right')
                print('Next slide')
                
            elif(self.name=="Horizontal Line Right to Left"):
                pyautogui.press('left')
                print('Prev slide')
                
            elif(self.name=="Diagonal Bottom Right to Top Left"):
                pyautogui.press('left')
                print('Prev slide')
                
            elif(self.name=="Diagonal Top Right to Bottom Left"):
                pyautogui.press('left')
                print('Prev slide')
